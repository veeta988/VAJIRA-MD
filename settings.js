...
global.owner = process.env.OWNER_NUMBER  || '94761681904' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=aYNiWYDI#UdTYCSpCFAClQoVzM4sZGm1ibsmfQrUGVfX91S2_M-E' ,
